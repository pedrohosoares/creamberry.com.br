jQuery(function ($) {
	...
	$(document).ready(function() {
		...
		$('.cpa-color-picker').each(function(){
			$(this).wpColorPicker({
				palettes: ['#f17e7e', '#dc6068', '#dd685b', '#e9845c', '#f0b464', '#f5cf69', '#c5d377', '#a5d276', '#6cc878', '#6fcbc0', '#6ebfe3', '#6b9ce7', '#9498e6', '#a979d2', '#df8cbc', '#d5ab9c', '#796465', '#727272', '#000000']
			});
		})
